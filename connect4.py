...
class Game(object):
    ...
    def __init__(self):
        ...
        while self.players[0] == None:
            ...
            print('1. Human')
            print('2. Computer')
            choice = str(input("Type '1' or '2': "))
            print()
            if choice == "Human" or choice.lower() == "1":
                name = str(input("Enter Player 1's name: "))
                self.players[0] = Player(name, self.colors[0])
            elif choice == "Computer" or choice.lower() == "2":
                name = str(input("Enter Player 1's name: "))
                diff = int(input("Enter difficulty for this AI (1 - 3): "))
                self.players[0] = AIPlayer(name, self.colors[0], diff+1)
                while diff > 3:
                    diff = int(input("Maximum difficulty is 3: "))
            else:
                print("Invalid choice, please try again")
        print("Player '{0}' will be playing as '{1}'".format(self.players[0].name, self.colors[0]))
        ...
        while self.players[1] == None:
            ...
            print()
            if choice == "Human" or choice.lower() == "1":
                name = str(input("Enter Player 2's name: "))
                ...
                print("Invalid choice, please try again")
        print("Player '{0}' will be playing as '{1}'".format(self.players[1].name, self.colors[1]))
...
class Player(object):
    ...
    def move(self, state):
        print("{0}'s turn (playing as {1})".format(self.name, self.color))
        column = None
        while column == None:
            try:
